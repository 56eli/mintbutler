...
|---|---|---|---|---|---|
| 001 | .orchestrator/prompts/001-butler-core-discovery.md | butler core: menu script, module discovery, flags, tracker bootstrap | feature/butler-core-discovery | — | Dispatched 2026-09-16 |

## Active Milestone
v0.1 — menu script + module discovery + modulelint + the two seed modules.

## Task Queue
- [ ] 001: butler core + discovery + PROJECT_STATE.md bootstrap (In Progress — dispatched)
- [ ] 002: bin/modulelint contract validator (Pending — next)
