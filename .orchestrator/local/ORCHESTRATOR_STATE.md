...
- 2026-09-18 | release | owner requested v1.0 release with step-by-step user guide — SHIPPED: tag v1.0 on main tip b4e9464, release https://github.com/56eli/mintbutler/releases/tag/v1.0, release notes = full user guide (getting it, starting ./butler, menu + confirmation contract, per-module step-by-step with what to expect, safety summary); GitHub auto-generated source tarball/zip serve as the v1.0 script download; standalone guide ASSET upload not possible from this sandbox (uploads.github.com EOF-blocked, 3 attempts) — guide persists in release notes + workspace copy /home/user/mintbutler-user-guide-v1.0.md; owner may attach the asset manually or order a docs/USER_GUIDE.md repo copy later
