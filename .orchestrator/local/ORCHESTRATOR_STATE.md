...
| 016 | .orchestrator/prompts/016-system-report-pack.md | system-report-pack: read-only plain-text system report, zero installs (never inxi), risk low, order 70 | — | — | Published + dispatched 2026-09-17 |
...
- [~] 016: system-report-pack — IN PROGRESS (build order 8; read-only snapshot, zero installs never inxi, asks 0, order 70); prompt 016 published + dispatched
